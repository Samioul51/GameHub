    ...
    return (
        ...
        >
            <div className='w-full max-w-[317px] flex flex-col p-[16px] box-border bg-white inter rounded-[8px] shadow-lg mx-auto'>
                ...
                <Link to={`/gamedetails/${id}`} className='w-full max-w-full bg-linear-to-r from-[#632EE3] to-[#9F62F2] text-center text-white font-semibold rounded-[8px] py-[5px] mt-[10px] cursor-pointer'>SEE MORE</Link>
            </div>
        </motion.div>
    );
};
